...
namespace BackOffice.Specs.Domain
{
    ...
    internal class When_comparing_unsaved_entities_with_identical_values
    {
        protected static Person Person1;
        protected static Person Person2;
    ...
    [Subject(typeof(DomainEntity))]
    internal class When_comparing_unsaved_entities_with_different_values
    {
        protected static Person Person1;
        protected static Person Person2;
    ...
    [Subject(typeof(DomainEntity))]
    internal class When_comparing_saved_entities_with_different_id_s
    {
        protected static Person Person1;
        protected static Person Person2;
    ...
    [Subject(typeof(DomainEntity))]
    internal class When_comparing_saved_entities_with_identical_id_s
    {
        protected static Person Person1;
        protected static Person Person2;
    ...
    [Subject(typeof(DomainEntity))]
    internal class When_comparing_the_same_entity_with_itself
    {
